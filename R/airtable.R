...
#' @param fields An optional `airtable_fields_schema` object. Automatically populated in tables created by `airtable_base()`
...
airtable <- function(table, base, view = NULL, fields = list(), api_url = 'https://api.airtable.com', api_version = 0){
  
  atbl <- new_airtable(table, base, view, fields, api_url = api_url, api_version = as.integer(api_version))
